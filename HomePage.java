...
public class HomePage extends ProjectSpecification {
	...
	//constructor initialization
			...
			//Method to click Flight status tab and constructor chaining done to return to flight status page 
			...
			//Method to click manage booking tab and constructor chaining done to return to manage booking  page 
